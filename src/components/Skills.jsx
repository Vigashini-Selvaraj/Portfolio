export default function Skills() {
  const skills = [
    { img: "/assets/html-5.png", title: "HTML" },
    { img: "/assets/css-3.png", title: "CSS" },
    { img: "/assets/js.png", title: "JAVASCRIPT" },
    { img: "/assets/physics.png", title: "REACT" },
    { img: "/assets/python.png", title: "PYTHON" },
    { img: "/assets/sql-server.png", title: "MYSQL" },
  ];
    ...
    <section id="skills" className="bg-gradient-to-b from-[#020617] to-[#0c1222] py-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-6 py-10 place-items-center">
        {skills.map((skill, ind) => (
          ...
          >
            <img src={skill.img} alt={skill.title} className="h-16 w-16 mb-5" />
